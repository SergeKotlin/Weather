...
import com.android1.weather.data.RepositoryImpl
...
class MainViewModel(
    ...
    fun getWeather() = getWeatherFromLocalSource()

    private fun getWeatherFromLocalSource() { // Имитирует запрос к БД (или ещё какому-то источнику данных в приложении)
    ...
    fun getWeatherFromRemoteSource() = getWeatherFromLocalSource() // Костыль
}